...
// Wrappers for CUFFT plans according to data precision
...
// Wrapper for CUFFT execution according to data type
...
// Wrappers for FFTW plans according to data precision
...
// cufftHandle cufft_plan_create_wrapper(double dummy,...,  cufftDoubleComplex*, ...){}
// cufftHandle cufft_plan_create_wrapper(float dummy,..., cufftComplex*, ...){}
...
// Wrappers for FFTW execution according to data precision
