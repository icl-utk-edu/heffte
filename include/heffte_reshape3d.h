...
class reshape3d_alltoall : public reshape3d_base<index>, public backend::device_instance<backend_tag>{
public:
...
private:
     ...
     */
    reshape3d_alltoall(typename backend::device_instance<backend_tag>::stream_type q,
...
std::unique_ptr<reshape3d_alltoall<backend_tag, packer, index>>
 ...
 */
template<typename backend_tag, template<typename device> class packer, typename index>
class reshape3d_alltoallv : public reshape3d_base<index>, public backend::device_instance<backend_tag>{
public:
    //! \brief Destructor, frees the comm generated by the constructor.
 ...
 */
template<typename backend_tag, template<typename device> class packer, typename index>
class reshape3d_pointtopoint : public reshape3d_base<index>, public backend::device_instance<backend_tag>{
public:
    //! \brief Destructor, frees the comm generated by the constructor.
...
class reshape3d_transpose : public reshape3d_base<index>, public backend::device_instance<typename backend::default_backend<location_tag>::type>{
public:
    //! \brief Constructor using the provided unpack plan.
    reshape3d_transpose(typename backend::device_instance<typename backend::default_backend<location_tag>::type>::stream_type q,
        ...
        backend::device_instance<typename backend::default_backend<location_tag>::type>(q),
        plan(cplan)
        {}
...
std::unique_ptr<reshape3d_base<index>> make_reshape3d(typename backend::device_instance<backend_tag>::stream_type stream,
                                               std::vector<box3d<index>> const &input_boxes,
                                               std::vector<box3d<index>> const &output_boxes,
                                               MPI_Comm const comm,
